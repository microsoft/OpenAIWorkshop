...
### 1. Fully automated script. (Not in the scope of today's workshop)
...
### 2. Semi automated script. (We will implement this script in today's workshop) 
...
- Optionally, powerapp can be configured instead of chatbot. 
