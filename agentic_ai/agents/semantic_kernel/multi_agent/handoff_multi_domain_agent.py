    ...
    async def _setup_agents(self) -> None:
        ...
        self._agent = ChatCompletionAgent(
            ...
            instructions=(
                ...
                "if you need clarification or info is not complete, ask followup questions"
                "Like if the customer asks questions without providing identifying information such as customer ID, ask for it"
            ),
