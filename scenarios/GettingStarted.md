...
1. Confirm you have a resource group present with name **<inject key="DeploymentID" enableCopy="false" />**. Last six digits in the resource group name are unique for every user.
